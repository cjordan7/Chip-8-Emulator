...
void CPU::opcodeDxyn() {
    ...
    // FIXME: TODO: Change and Write it
...
// FIXME: TODO Refactor and use as another way to execute an instruction
// FIXME: Maybe use a function for chosing between one or the other
void CPU::executeInstruction() {
    switch(opcode & 0xF000) {
        case 0x0000:
            // Opcode: 00E*

            // FIXME: TODO: Use function
...
//    executeInstruction();
	...
	if (soundTimer > 0) {
        if(soundTimer == 1) {
            // FIXME: TODO: Sound... use beep, use SDL
        }
		--soundTimer;
	}
